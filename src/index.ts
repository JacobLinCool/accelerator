...
export default {
    async fetch(req: Request, env: Env): Promise<Response> {
        ...
        // if (url.pathname.startsWith("/test-event")) {
        //     const instanceId = url.searchParams.get("instanceId");
        //     const eventType = url.searchParams.get("eventType") || "test-event";
        //     if (instanceId && env.TEST_WORKFLOW) {
        //         try {
        ...
        //     return Response.json({ instanceId: ins.id, triggerUrl: triggerUrl.toString() });
        // }
